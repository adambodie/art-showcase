...
const About = () => (
	<div>
		<div className="about">
			...
			<img src="img/teenager.jpg" alt="Adam" className="img-responsive" id="teenager"/>
		...
		<div className="initial">
			...
			<p>Here were my initial thoughts from my art showcase back in 2001-2002.  As you can see, a lot has changed since then, among the notable changes was that I actually had hair when I was young.  Other than that, I'm still the same artistic person but with a different career path and improved maturity and personality.</p>
			<img src="img/initial-thoughts.jpg" alt="Initial thoughts" className="img-responsive"/>
		</div>
	</div>
)
